...
H1 <- readRDS(here('results/gam_results/unadjusted/twin_telot2_res.RDS'))
H2 <- readRDS(here('results/gam_results/unadjusted/twin_telot3_res.RDS'))
H3 <- readRDS(here('results/gam_results/unadjusted/twin_dtelo_res.RDS'))
H1adj <- readRDS(here('results/gam_results/adjusted/twin_telot2_adj_res.RDS'))
H2adj <- readRDS(here('results/gam_results/adjusted/twin_telot3_adj_res.RDS'))
H3adj <- readRDS(here('results/gam_results/adjusted/twin_dtelo_adj_res.RDS'))
...
save_as_docx("Twin Sensitivity Analysis: Association Between Telomere Length at Year 1 and Growth" = tbl1flexsupp, 
             ...
             path="C:/Users/Sophia/Documents/WASH/WASH Telomeres and Growth/telo-growth twin sensitivity analysis tables.docx",
             pr_section = sect_properties)
