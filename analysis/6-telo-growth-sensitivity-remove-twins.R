...
# remove twins
# check if any other childids other than 351051, 311022, 234042 end in 2 (twin)
grep('.2$', d$childid, value=T)
# remove just 351051, 311022, 234042 childids
d <- d %>% filter(!(d$childid %in% c(351051, 311022, 234042)))
...
#Save models
saveRDS(H1_models, here("results/gam_models/unadjusted/twin_telot2_models.RDS"))

#Save results
saveRDS(H1_res, here("results/gam_results/unadjusted/twin_telot2_res.RDS"))

#Save plot data
saveRDS(H1_plot_data, here("results/gam_figure_data/unadjusted/twin_telot2_unadj_spline_data.RDS"))
...
#Save models
saveRDS(H2_models, here("results/gam_models/unadjusted/twin_telot3_models.RDS"))

#Save results
saveRDS(H2_res, here("results/gam_results/unadjusted/twin_telot3_res.RDS"))

#Save plot data
saveRDS(H2_plot_data, here("results/gam_figure_data/unadjusted/twin_telot3_unadj_spline_data.RDS"))
...
#Save models
saveRDS(H3_models, here("results/gam_models/unadjusted/twin_dtelo_models.RDS"))

#Save results
saveRDS(H3_res, here("results/gam_results/unadjusted/twin_dtelo_res.RDS"))
...
#Save models
saveRDS(H1_adj_models, here("results/gam_models/adjusted/twin_telot2_adj_models.RDS"))

#Save results
saveRDS(H1_adj_res, here("results/gam_results/adjusted/twin_telot2_adj_res.RDS"))

#Save plot data
saveRDS(H1_adj_plot_data, here("results/gam_figure_data/adjusted/twin_telot2_adj_spline_data.RDS"))
...
#Save models
saveRDS(H2_adj_models, here("results/gam_models/adjusted/twin_telot3_adj_models.RDS"))

#Save results
saveRDS(H2_adj_res, here("results/gam_results/adjusted/twin_telot3_adj_res.RDS"))

#Save plot data
saveRDS(H2_plot_data, here("results/gam_figure_data/adjusted/twin_telot3_adj_spline_data.RDS"))
...
#Save models
saveRDS(H3_adj_models, here("results/gam_models/adjusted/twin_dtelo_adj_models.RDS"))

#Save results
saveRDS(H3_adj_res, here("results/gam_results/adjusted/twin_dtelo_adj_res.RDS"))
