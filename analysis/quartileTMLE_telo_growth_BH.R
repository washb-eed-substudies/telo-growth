...
delta_unadj <- filter(BH_unadj, A=="delta_TS")
...
t3_unadj <- filter(BH_unadj, A=="TS_t3")
h5unadj <- t3_unadj[grep("z_t3", t3_unadj$Y),]

t2_unadj <- filter(BH_unadj, A=="TS_t2")
...
save(h1unadj, h2unadj, h3unadj, h4unadj, h5unadj, h6unadj, h7unadj, h8unadj,
     ...
     file=here("results/telo_growth_results.Rdata"))
