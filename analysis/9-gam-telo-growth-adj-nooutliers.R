...
#Save models
saveRDS(H1_adj_models, here("results/gam_models/adjusted/telot2_adj_models_nooutliers.RDS"))

#Save results
saveRDS(H1_adj_res, here("results/gam_results/adjusted/telot2_adj_res_nooutliers.RDS"))

#Save plot data
saveRDS(H1_adj_plot_data, here("results/gam_figure_data/adjusted/telot2_adj_spline_data_nooutliers.RDS"))
...
#Save models
saveRDS(H2_adj_models, here("results/gam_models/adjusted/telot3_adj_models_nooutliers.RDS"))

#Save results
saveRDS(H2_adj_res, here("results/gam_results/adjusted/telot3_adj_res_nooutliers.RDS"))

#Save plot data
saveRDS(H2_plot_data, here("results/gam_figure_data/adjusted/telot3_adj_spline_data_nooutliers.RDS"))
...
#Save models
saveRDS(H3_adj_models, here("results/gam_models/adjusted/dtelo_adj_models_nooutliers.RDS"))

#Save results
saveRDS(H3_adj_res, here("results/gam_results/adjusted/dtelo_adj_res_nooutliers.RDS"))
